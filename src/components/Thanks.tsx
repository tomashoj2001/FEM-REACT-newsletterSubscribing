...
export default function Thanks({ email, setHome }: ThanksProps) {
  return (
    <div className="px-8 py-1 h-[99vh] md:h-auto md:max-w-[400px] md:p-8">
      <picture>
        <img src={img} alt="foto" className="mt-16 md:mt-0" />
      </picture>
      <h1 className="text-4xl font-bold mt-12 mb-8 text-dark-blue md:mt-8">Thanks for subscribing!</h1>
